...
Source0  : https://files.pythonhosted.org/packages/fe/cd/6d9a809234f97ca50d5015532eef7e33d52499fd10387b651f54ee466cb7/nbconvert-6.4.3.tar.gz
...
%prep
%setup -q -n nbconvert-6.4.3
cd %{_builddir}/nbconvert-6.4.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1647035624
...
cp %{_builddir}/nbconvert-6.4.3/LICENSE %{buildroot}/usr/share/package-licenses/pypi-nbconvert/4864371bd27fe802d84990e2a5ee0d60bb29e944
