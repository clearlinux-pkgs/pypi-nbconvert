...
Source0  : https://files.pythonhosted.org/packages/f2/e9/659ddf313e8248978232b5e30f6e71f78d64f350e2e5428402b3b7bd2fca/nbconvert-7.16.1.tar.gz
...
%prep
%setup -q -n nbconvert-7.16.1
cd %{_builddir}/nbconvert-7.16.1
pushd ..
cp -a nbconvert-7.16.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1708363772
