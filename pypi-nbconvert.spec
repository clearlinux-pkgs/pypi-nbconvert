...
Source0  : https://files.pythonhosted.org/packages/af/e8/ba521a033b21132008e520c28ceb818f9f092da5f0261e94e509401b29f9/nbconvert-7.16.4.tar.gz
...
%prep
%setup -q -n nbconvert-7.16.4
cd %{_builddir}/nbconvert-7.16.4
pushd ..
cp -a nbconvert-7.16.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1714434350
