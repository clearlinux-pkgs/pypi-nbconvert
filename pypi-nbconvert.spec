...
Source0  : https://files.pythonhosted.org/packages/30/ba/3eb8fce4fb252a29714609ddb036d49d8ceb71d5e89ef2a6ef61a59e3490/nbconvert-6.4.1.tar.gz
...
%prep
%setup -q -n nbconvert-6.4.1
cd %{_builddir}/nbconvert-6.4.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1643243629
...
cp %{_builddir}/nbconvert-6.4.1/LICENSE %{buildroot}/usr/share/package-licenses/pypi-nbconvert/4864371bd27fe802d84990e2a5ee0d60bb29e944
