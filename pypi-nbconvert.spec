...
Version  : 7.14.1
Release  : 86
URL      : https://files.pythonhosted.org/packages/38/fc/0d60ae67a3fff3d097a4f52523a6d04158feb4b930e9d2968130c3cfd1e4/nbconvert-7.14.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/38/fc/0d60ae67a3fff3d097a4f52523a6d04158feb4b930e9d2968130c3cfd1e4/nbconvert-7.14.1.tar.gz
...
%prep
%setup -q -n nbconvert-7.14.1
cd %{_builddir}/nbconvert-7.14.1
pushd ..
cp -a nbconvert-7.14.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1704986622
