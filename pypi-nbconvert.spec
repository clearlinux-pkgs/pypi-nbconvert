...
Source0  : https://files.pythonhosted.org/packages/8a/55/97826908be6005add50fe67b2809ede11c1e0f8342de23b2ce66a65591f2/nbconvert-7.14.2.tar.gz
...
%prep
%setup -q -n nbconvert-7.14.2
cd %{_builddir}/nbconvert-7.14.2
pushd ..
cp -a nbconvert-7.14.2 buildavx2
popd
pushd ..
cp -a nbconvert-7.14.2 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707127509
