...
Source0  : https://files.pythonhosted.org/packages/13/2a/cedc84c1555af478da0f2f67b9d0d42612aa0721ef544fb7adf06f8d7073/nbconvert-6.4.2.tar.gz
...
%prep
%setup -q -n nbconvert-6.4.2
cd %{_builddir}/nbconvert-6.4.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1644514202
...
cp %{_builddir}/nbconvert-6.4.2/LICENSE %{buildroot}/usr/share/package-licenses/pypi-nbconvert/4864371bd27fe802d84990e2a5ee0d60bb29e944
