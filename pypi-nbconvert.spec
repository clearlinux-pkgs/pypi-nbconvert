...
Source0  : https://files.pythonhosted.org/packages/5a/58/b31e8a37e8c43937e536d72abd1f3271ca3195a206088e8180fa1c437789/nbconvert-7.16.2.tar.gz
...
%prep
%setup -q -n nbconvert-7.16.2
cd %{_builddir}/nbconvert-7.16.2
pushd ..
cp -a nbconvert-7.16.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1709596266
