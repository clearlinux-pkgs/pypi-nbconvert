...
Version  : 6.5.2
Release  : 65
URL      : https://files.pythonhosted.org/packages/56/8f/fbd5769c2d83b288d7f057c4784a07a58bd284364aa5bda0f898ecc1cde0/nbconvert-6.5.2.tar.gz
Source0  : https://files.pythonhosted.org/packages/56/8f/fbd5769c2d83b288d7f057c4784a07a58bd284364aa5bda0f898ecc1cde0/nbconvert-6.5.2.tar.gz
...
%prep
%setup -q -n nbconvert-6.5.2
cd %{_builddir}/nbconvert-6.5.2
%patch1 -p1
%patch2 -p1
%patch3 -p1
%patch4 -p1
pushd ..
cp -a nbconvert-6.5.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1660166955
