...
Version  : 7.16.5
Release  : 96
URL      : https://files.pythonhosted.org/packages/46/2c/d026c0367f2be2463d4c2f5b538e28add2bc67bc13730abb7f364ae4eb8b/nbconvert-7.16.5.tar.gz
Source0  : https://files.pythonhosted.org/packages/46/2c/d026c0367f2be2463d4c2f5b538e28add2bc67bc13730abb7f364ae4eb8b/nbconvert-7.16.5.tar.gz
...
%prep
%setup -q -n nbconvert-7.16.5
cd %{_builddir}/nbconvert-7.16.5
pushd ..
cp -a nbconvert-7.16.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735829576
