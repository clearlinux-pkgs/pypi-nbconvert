...
Version  : 6.5.1
Release  : 64
URL      : https://files.pythonhosted.org/packages/69/fe/8e103c983876fedbffc1b679229db68c53e11c2006454920b28c558b416d/nbconvert-6.5.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/69/fe/8e103c983876fedbffc1b679229db68c53e11c2006454920b28c558b416d/nbconvert-6.5.1.tar.gz
...
%prep
%setup -q -n nbconvert-6.5.1
cd %{_builddir}/nbconvert-6.5.1
%patch1 -p1
%patch2 -p1
%patch3 -p1
%patch4 -p1
pushd ..
cp -a nbconvert-6.5.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1660145216
