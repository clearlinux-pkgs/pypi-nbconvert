...
Source0  : https://files.pythonhosted.org/packages/27/59/80e892f69ada6d9be25b1f71c5b0b67ff084feaef9875ff1e120264e974d/nbconvert-6.4.5.tar.gz
...
%prep
%setup -q -n nbconvert-6.4.5
cd %{_builddir}/nbconvert-6.4.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1648497503
...
cp %{_builddir}/nbconvert-6.4.5/LICENSE %{buildroot}/usr/share/package-licenses/pypi-nbconvert/4864371bd27fe802d84990e2a5ee0d60bb29e944
