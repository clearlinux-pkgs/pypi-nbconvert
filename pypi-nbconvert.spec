...
Source0  : https://files.pythonhosted.org/packages/6e/d8/69385c6f0ed02347810c37c031ba5990cd453f53f44e5d89c2712612a553/nbconvert-6.4.4.tar.gz
...
%prep
%setup -q -n nbconvert-6.4.4
cd %{_builddir}/nbconvert-6.4.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1647103186
...
cp %{_builddir}/nbconvert-6.4.4/LICENSE %{buildroot}/usr/share/package-licenses/pypi-nbconvert/4864371bd27fe802d84990e2a5ee0d60bb29e944
